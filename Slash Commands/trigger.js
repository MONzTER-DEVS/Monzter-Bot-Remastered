...
module.exports = class Trigger extends SlashCommand{
    constructor(creator) {
        super(creator, {
            name:"trigger",
            description: "Trigger your avatar.",
            ...
            options: [
                {
                    name: "user",
                    description: 'The user you want to trigger the avatar of.',
    ...
    async run(ctx){
        ...
        const attachment = await Canvas.trigger(img);
        await ctx.defer();
